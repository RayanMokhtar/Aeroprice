...
<header>
  ...
  <main class="main-container">
    ...
    <div class="container d-flex justify-content-center align-items-center min-vh-100 " style="background-color: #0C274E;">
      <div class="row border rounder-5 p-3 bg-white shadow box-area ">
        <div class="col-md-6 rounded-4 d-flex justify-content-center align align-items-center flex-column left-box " style="background-color: #ffffff; background-size: cover;">    
          <div class="featured-image" style="background: #ffffff;">
            <figure>
              <img src="logo1.png" class="img_fluid" alt="background du body" style="width:300px; ">
    ...
    <div id="prenomMessage"></div>
            ...
            <div class="input-group mb-4 d-flex">
              ...
              <div class="forgot">
                <small>Se souvenir de moi ? <a href="nouveau_mdp.html"> Mot de passe oublié? </a></small>
              </div>
            </div>
            <!--button-->
            ...
            <div class="row">
              <small>vous disposez déjà d'un compte ? <a href="connexion.html">Se connecter</a> </small>
            </div>
            <div class="row mt-5">
...
function onSubmit(token) {
    ...
    if (ajaxSuccessLogin && ajaxSuccessMail && passwordValid && passwordMatch) {
        ...
        // Afficher un message d'erreur si certaines vérifications ont échoué
