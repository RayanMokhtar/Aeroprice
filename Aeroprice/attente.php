...
<body>
    <div class="message-box text-center">
        ...
        <p>Avez-vous reçu cet email ? Si ce n'est pas le cas, consultez votre dossier de courriers indésirables Si votre adresse email n'a pas été validée dans les 3 jours, il est possible que vous deviez créer un nouveau compte. Si vous rencontrez des problèmes, consultez l'Aide sur votre compte.</p>
         
        <a href="politique.html" target="_blank">Conditions d'utilisation et confidentialité</a> | 
        <a href="politique.html"  target="_blank">Gestion et préférences en matière de cookies</a>
    </div>
</body>
</html>
